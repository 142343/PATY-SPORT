...
<body>
                                ...
                                while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <span class="pending" style="font-size: 10px;"><i class="fas fa-info-circle"> Pendiente</i></span>
                                            <?php endif; ?>
                                        </td>    
                                     <td>
    <?php if (isset($fila['EstadoCodigoEstado']) && $fila['EstadoCodigoEstado'] !== null && $fila['EstadoCodigoEstado'] !== ''): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <span class="pending" style="font-size: 5px;"><i class="fas fa-info-circle"> Pendiente</i></span>
    <?php endif; ?>
</td>
