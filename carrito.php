...
<body>
    ...
    <div class="modal-body">
        <form id="orderForm" action="EnvioEmail.php" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tel" id="phone" name="phone" class="form-control" placeholder="Ingresa tu teléfono" required>
            </div>!-->
            <div class="mb-3">
            ...
            <div class="modal-footer">
                <button type="submit" name="submitContact" class="btn btn-success btn-block" >Enviar</button>
            </div>
        </form>
    </div>
</div>
...
orderForm.addEventListener('submit', (e) => {
    ...
    if (carrito) {
        ...
        payload.carrito = JSON.parse(carrito);
