...
class Producto
{
    ...
    public function __construct($CodigoProducto = null, $Nombre = null,  $Precio = null, $Stock = null, $IVA = null, $CategoriaCodigoCategorías = null, $EstadoCodigoEstado = null, $Descripcion = null, $MarcasCodigoMarca = null, $TallasCodigoTallas = null, $Proveedor = null, $Num_Documento = 'ACTIVO')
    {
    ...
    public function agregarProducto($Nombre, $Precio, $Stock, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $TallasCodigoTallas, $Num_Documento)
    {
        $sql = "INSERT INTO producto (Nombre, Precio, Stock, IVA, CategoriaCodigoCategoría, EstadoCodigoEstado, Descripcion, MarcasCodigoMarca, TallasCodigoTallas, Num_Documento) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $this->Conexion->prepare($sql);
        $stmt->bind_param("siiiiisiii", $Nombre, $Precio, $Stock, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $TallasCodigoTallas, $Num_Documento);
        $stmt->execute();
        $stmt->close();
    }
    ...
    public function consultarProducto($CodigoProducto = null)
    {
        if ($CodigoProducto === null) { 
            $sql = "SELECT `CodigoProducto`, `Nombre`, `Precio`, `Stock`, `IVA`, 'CategoriaCodigoCategoría', `Descripcion`, `Num_Documento`,
    ...
    public function actualizarProducto($CodigoProducto, $Nombre, $Precio, $Stock, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $TallasCodigoTallas, $Num_Documento)
    {
        $sql = "UPDATE producto SET Nombre=?, Precio=?, Stock=?, IVA=?, CategoriaCodigoCategoría=?, EstadoCodigoEstado=?, Descripcion=?, MarcasCodigoMarca=?, TallasCodigoTallas=?,  Num_Documento=? WHERE CodigoProducto=?";
        $stmt = $this->Conexion->prepare($sql);
        $stmt->bind_param("siiiiisiiii", $Nombre, $Precio, $Stock, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $TallasCodigoTallas, $Num_Documento, $CodigoProducto);
