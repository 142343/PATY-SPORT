...
<button class="btn custom-btn mt-3" style="background-color: #007bff; " 
            onmouseover="this.style.backgroundColor='#87ceeb'" 
            onmouseout="this.style.backgroundColor='#007bff'" 
            data-bs-toggle="modal" data-bs-target="#addModall">Agregar Categoría</button>

<button class="btn custom-btn mt-3" style="background-color: #007bff; " 
            onmouseover="this.style.backgroundColor='#87ceeb'" 
            onmouseout="this.style.backgroundColor='#007bff'"  
            data-bs-toggle="modal" data-bs-target="#addModalll">Agregar Talla</button>

            <button class="btn custom-btn mt-3" style="background-color: #007bff;" 
            onmouseover="this.style.backgroundColor='#87ceeb'" 
            onmouseout="this.style.backgroundColor='#007bff'"  
            data-bs-toggle="modal" data-bs-target="#addModallll">Agregar Marca</button>
