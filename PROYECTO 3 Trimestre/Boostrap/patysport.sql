...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-09-2024 a las 16:54:13
...
(301, 'Sudadera de Hombre', 30000, 12, 19, NULL, 123, 101, 'Sudadera en algodon perchado y cierres en los bolsillos', 31, 207, 1004785525),
...
--
ALTER TABLE `producto`
  MODIFY `CodigoProducto` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=307;
