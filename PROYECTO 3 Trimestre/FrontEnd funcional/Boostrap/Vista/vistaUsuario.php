...
<body style="
    ...
    <div class="container-fluid d-flex justify-content-center">  
        <form class="d-flex" id="searchForm">  
            <input class="form-control me-2" type="search" placeholder="Buscar por nombre..." aria-label="Search" id="searchInput">  
    ...
    <div class="container-o">
        <div class="row">
            ...
            <ul>
                ...
                <li><a href="../Controlador/ControladorUsuario.php">Usuarios</a></li>
...
<button class="btn btn-success mt-3" data-bs-toggle="modal" data-bs-target="#addModal">Agregar Usuario</button>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (isset($resultado) && $resultado->num_rows > 0) {
                        ...
                        <td><?= htmlspecialchars($fila['Teléfono']) ?></td>
                        <td><?= htmlspecialchars($fila['Correo']) ?></td>
                        <td><?= htmlspecialchars($fila['RolidRol']) ?></td>
                        <td><?= htmlspecialchars($fila['EstadoCodigoEstado']) ?></td>
                        <td><?= htmlspecialchars($fila['GeneroidGenero']) ?></td>
