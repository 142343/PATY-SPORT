...
-- Tiempo de generación: 08-10-2024 a las 13:31:16
...
INSERT INTO `detalle_ingreso` (`ProductoCodigoProducto`, `Ticket SalidaidTicketIngreso`, `Cantidad`, `Descripción`, `PrecioIngreso`) VALUES
(301, 1, 6, 'NULL', 17000),
(302, 5, 8, 'NULL', 25000),
(303, 4, 8, 'NULL', 32000),
(304, 3, 10, 'NULL', 35000),
...
(305, 7, 1, 25000, 1033743193),
(305, 8, 1, 25000, 80461462),
(306, 4, 3, 30000, 1033743193),
(308, 5, 2, 50000, 80461462),
(310, 9, 1, 40000, 80461462),
(313, 6, 4, 50000, 1033743193),
(314, 10, 2, 30200, 80461462),
...
(301, 'Sudadera de Dama', 30000, 10, 19, NULL, 124, 102, 'Sudadera en algodon perchado y cierres en los bolsillos', 38, 206, 505547805),
...
(305, 'Sudadera de Dama', 25000, 0, 19, NULL, 123, 101, 'Sudadera encauchada en pretina y bota', 32, 207, 1033743193),
(306, 'Pantaloneta corta', 30000, 2, 19, NULL, 126, 101, 'Pantaloneta corta con cordón y bolsillos herméticos material impermeable y forrada en malla interna', 33, 206, 1025789945),
(307, 'Chaqueta cuero', 90000, 3, 19, NULL, 122, 103, 'ghghgjh', 36, 202, 505547805),
(308, 'Buzo Overzice', 50000, 1, 19, NULL, 122, 101, 'fhgjh', 33, 205, 1004785525),
(309, 'Camisa', 30000, 4, 19, NULL, 124, 102, 'ghfgjgj', 40, 204, 224587524),
(310, 'Camisa', 40000, 1, 19, NULL, 123, 102, 'dgsdgdgd', 38, 203, 80457897),
...
(313, 'Sudadrea negra', 50000, 72, 19, NULL, 123, 103, 'jxhcdashu', 39, 205, 1004785525),
(314, 'Sudadrea blanca', 30200, 21, 19, NULL, 122, 102, 'dsfsdf', 37, 203, 505547805),
...
--
ALTER TABLE `ticket_salida`
  MODIFY `IdTicketSalida` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
