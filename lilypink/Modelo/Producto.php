...
class Producto
{
    ...
    public function __construct($CodigoProducto = null, $Nombre = null, $Precio = null, $Stock = null, $IVA = null, $CategoriaCodigoCategorías = null, $EstadoCodigoEstado = null, $Descripcion = null, $MarcasCodigoMarca = null, $Proveedor = null, $Num_Documento = 'ACTIVO', $Imagen = null) // Agregado parámetro de imagen
    {
    ...
    public function agregarProducto($Nombre, $Precio, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $Num_Documento)
{
    $sql = "INSERT INTO producto (Nombre, Precio, IVA, CategoriaCodigoCategoría, EstadoCodigoEstado, Descripcion, MarcasCodigoMarca, Num_Documento) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $this->Conexion->prepare($sql);
    
    $stmt->bind_param("siisisis", $Nombre, $Precio, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca,  $Num_Documento);
    ...
    public function actualizarProducto($CodigoProducto, $Nombre, $Precio, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $Num_Documento)
    {
        $sql = "UPDATE producto SET Nombre=?, Precio=?, IVA=?, CategoriaCodigoCategoría=?, EstadoCodigoEstado=?, Descripcion=?, MarcasCodigoMarca=?,  Num_Documento=? WHERE CodigoProducto=?";
        $stmt = $this->Conexion->prepare($sql);
        $stmt->bind_param("siiiisiii", $Nombre, $Precio, $IVA, $CategoriaCodigoCategorías, $EstadoCodigoEstado, $Descripcion, $MarcasCodigoMarca, $Num_Documento, $CodigoProducto);
