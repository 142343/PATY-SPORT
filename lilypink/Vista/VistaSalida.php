...
<body><div class="sidebar" style="background: rgb(208,141,202); color: black;
...
.sidebar {
    width: 100px;
    text-align: center;
    color: black; /* Color base para texto */
    font-weight: bold;
}
...
.stacked-text {
    ...
    font-family: 'Dancing Script';
        line-height: 1.0; /* Espaciado entre letras */
    color: black; /* Color rosa fuerte */
}
    ...
    <div class="modal-dialog modal-sm" style="max-width: 40%; margin: 1rem auto;">
        <div class="modal-content rounded-3 shadow-lg" style="background: rgba(0, 0, 0, 0.6); color: #fff;">
            ...
            <div class="modal-body">
                <form id="formSalida" action="../Controlador/ControladorSalida.php" method="post" onsubmit="return validarStock();">
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <select name="ProductoCodigo" id="ProductoCodigo" class="form-control border-primary rounded-3 shadow-sm" style="border: 2px solid #ffffff; border-radius: 0.3rem; padding: 0.4rem; font-size: 0.9rem; width: 60%;" required>
                            ...
                            <?php while($row=mysqli_fetch_assoc($sqlp)){ ?>
                                <option value="<?php echo $row['CodigoProducto']; ?>" data-stock="<?php echo $row['Stock']; ?>">
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <input class="form-control border-primary rounded-3 shadow-sm" id="Cantidad" name="Cantidad" type="number" required style="border: 2px solid #ffffff; border-radius: 0.3rem; padding: 0.4rem; font-size: 0.9rem; width: 60%;" min="1" inputmode="numeric">
                    </div>
...
<!-- Incluir librería SweetAlert2 -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

<script>
    function validarStock() {
        const productoSelect = document.getElementById('ProductoCodigo');
        const cantidadInput = document.getElementById('Cantidad');
        const stockDisponible = parseInt(productoSelect.options[productoSelect.selectedIndex].getAttribute('data-stock'));
        ...
        if (cantidadSolicitada > stockDisponible) {
            Swal.fire({
                icon: 'error',
                title: '¡Oops!',
                text: 'La cantidad solicitada excede el stock disponible.    Por favor, revise la cantidad del producto e intente de nuevo. 😢',
